...
void goWithAction(int direction, int speed, float inches, int degrees2, int time){
...
void oldTurnPID(float direction, float degrees, float speed, float wait){
...
void oldGoPID (float degrees, float speed, float wait){
