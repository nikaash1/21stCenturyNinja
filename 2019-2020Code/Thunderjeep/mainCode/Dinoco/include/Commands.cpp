  ...
  //red
    ...
    if (autoColor == 1){
      if (autoNumber == 1){
        ...
        upMove2(FORWARD, FAST, 710);
        goOldPID(21.5, 1, 0.105, 80, 0.05);
        upMove(BACKWARD, FAST, 120);
        intakeMove(BACKWARD, FAST, 370);
        upMove(BACKWARD, 90, 850);
        goSides(FORWARD, FORWARD, 30, 30, 3.2, 3.2);
        intakeMove(FORWARD, FAST, 370);
        intakeSpin(FORWARD, 100);
        upMove(FORWARD, MEDIUM, 200);
        ...
        //back
        resetDrive();
        goEncoder(BACKWARD, 55, 16.5);
        goH(RIGHTH, 80, 2);
        resetDrive();
        /*while(RF.isSpinning()){
          wait(1);
        }*/
        goSides(BACKWARD, BACKWARD, 80, 40, 4, 30);
        /*while((LF.isSpinning())||(RF.isSpinning())){
          wait(1);
        }*/
        //resetDrive();
        ...
        upMove(BACKWARD, 100, 80);
        intakeMove(BACKWARD, FAST, 650);
        upMove(FORWARD, 100, 80);
        goo(BACKWARD, 60, 3, 0, 0);
        while(RF.isSpinning()){
          wait(1);
        }
